...
qemu-system-x86_64 -m 4G -drive id=disk,file=/home/luke/BobaOS/cmake-build-debug/os.bin,format=raw,if=none -device ahci,id=ahci -device ide-hd,drive=disk,bus=ahci.0 -S -gdb tcp::1234
